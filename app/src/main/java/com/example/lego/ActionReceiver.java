...
public class ActionReceiver extends BroadcastReceiver implements IaResultHandler {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //context.sendBroadcast(it); 이거 해결해야됨
...
/*
    public void performAccept(Context context, int m_nSeqPlanElem) {
        ...
        if(CaApplication.m_Info.m_alPlan.isEmpty()){
            it=new Intent(context, com.example.kuime.ActivityLogin.class);
        }
        else {
