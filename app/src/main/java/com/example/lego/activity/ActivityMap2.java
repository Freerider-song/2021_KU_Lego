...
public class ActivityMap2 extends AppCompatActivity implements IaResultHandler, OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //현재 위치 표시시
        mLayout = findViewById(R.id.cl_map);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( ActivityMap2.this, REQUIRED_PERMISSIONS,
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, Seoul
        LatLng DEFAULT_LOCATION = new LatLng(33.5101562, 126.4681157);
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ActivityMap2.this);
